      ...
      <section>
        <div className="min-h-screen">
          ...
          <p className="px-10 text-lg">
            ...
            protocol. Each NFT stores a randomly generated hash, which is used as the
            seed to deterministically select the color scheme and grid attributes. To
            make it a bit more fun, the colors in the squares randomize with each
            reload.
          </p>
          ...
          <p className="px-10 text-lg">
            This is basically just for fun, and to hopefully onboard more people into
            the NEAR ecosystem by showcasing how cheap it is to mint NFTs.
          </p>
        </div>
      </section>
      <Footer />
